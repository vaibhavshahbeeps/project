...
<div class="baneer-w3ls">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="menu.html">
								<img class="card-img-bottom" src="/assests/images/blog1.jpg" alt="Card image cap"/>
							</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="menu.html">
								<img class="card-img-bottom" src="/assests/images/blog2.jpg" alt="Card image cap"/>
							</a>
						</div>
						<div class="card-body border border-top-0">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="menu.html">
								<img class="card-img-bottom" src="/assests/images/blog3.jpg" alt="Card image cap"/>
							</a>
						</div>
						<div class="card-body border border-top-0">
	...
	<section class="middle py-5" id="services">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row grids-w3 py-xl-5 py-lg-4 pt-lg-0 pt-4">
				<div class="col-lg-5 w3pvt-lauits_banner_bottom_left">
					<div class="row">
						...
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center">
							<img src="/assests/images/s1.png" alt="" class="img-fluid"/>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-5 w3pvt-lauits_banner_bottom_left mt-lg-0 mt-4">
					<div class="row">
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center">
							<img src="/assests/images/s2.png" alt="" class="img-fluid"/>
						</div>
				...
				<div class="col-lg-4 w3pvt-lauits_banner_bottom_left">
					<div class="row">
						...
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center pr-lg-0">
							<img src="/assests/images/s3.png" alt="" class="img-fluid"/>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 w3pvt-lauits_banner_bottom_left mt-lg-0 mt-4">
					<div class="row">
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center pl-lg-0">
							<img src="/assests/images/s4.png" alt="" class="img-fluid"/>
						</div>
		...
		<div class="img-blog-2">
			<img src="/assests/images/img.png" alt="" class="img-fluid"/>
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="single.html">
								<img src="/assests/images/blog1.png" class="card-img-bottom img-fluid" alt="image"/>
							</a>
							<img src="/assests/images/te1.jpg" alt="" class="img-blog rounded-circle img-fluid"/>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="single.html">
								<img src="/assests/images/blog2.png" class="card-img-bottom img-fluid" alt="image"/>
							</a>
							<img src="/assests/images/te2.jpg" alt="" class="img-blog rounded-circle img-fluid"/>
						</div>
						<div class="card-body text-center pt-5 mt-2">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="single.html">
								<img src="/assests/images/blog3.png" class="card-img-bottom img-fluid" alt="image"/>
							</a>
							<img src="/assests/images/te3.jpg" alt="" class="img-blog rounded-circle img-fluid"/>
						</div>
						<div class="card-body text-center pt-5 mt-2">
	...
	<section class="subscribe-main py-5">
		<div class="container py-xl-5 py-3">
			...
			<img src="/assests/images/sub.png" alt="" class="img-fluid sub-img"/>
		</div>
	</section>
